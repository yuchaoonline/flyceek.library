...
namespace FindProperty.Lib.BLL.Common.DALFactory
{
    public class DbDataAccessFactory : IDataAccessFactory
    {
        ...
        {
            ISubWayCriteria idal = PolicyInjectionFactory.Create().Create<DAL.Db.SubWayCriteria, ISubWayCriteria>();
        ...
        {
            ISubStationCriteria idal = PolicyInjectionFactory.Create().Create<DAL.Db.SubStationCriteria, ISubStationCriteria>();
        ...
        {
            ISearchAutoComplete idal = PolicyInjectionFactory.Create().Create<DAL.Db.SearchAutoComplete, ISearchAutoComplete>();
        ...
        {
            IMatchHouseSearchKeyword idal = PolicyInjectionFactory.Create().Create<DAL.Db.MatchHouseSearchKeyword, IMatchHouseSearchKeyword>();
        ...
        {
            ISearchRecommendTag idal = PolicyInjectionFactory.Create().Create<DAL.Db.SearchRecommendTag, ISearchRecommendTag>();
