...
namespace ComLib.Entities
{
    ...
    /// The real NHibernate repository is located in the CommonLibrary.Providers assembly.
    /// 
    /// This is an in-memory repository, Useful for Unit/Integration/ tests.
    /// The actual implementation of the Repositry is in the CommonLibrary.Providers project.
    /// It will currently use Hibernate for dataaccess.
    /// </summary>
