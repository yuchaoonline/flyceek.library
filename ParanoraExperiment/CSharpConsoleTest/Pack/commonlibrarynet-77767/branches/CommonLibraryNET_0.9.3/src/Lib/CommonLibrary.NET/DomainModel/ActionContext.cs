...
namespace ComLib.Entities
{
    ...
    public class ActionContext<T> : ActionContext
    {
        ...
        /// <param name="errors">Error collection</param>
        /// <param name="messages">Message collection</param>
        public ActionContext(T item, IValidationResults errors, IStatusResults messages) : base(item, errors, messages)
        {
        }
        ...
        /// <param name="errors">Error collection</param>
        /// <param name="messages">Message collection</param>
        public ActionContext(IValidationResults errors, IStatusResults messages, int id) : base(errors, messages, id)
        {
        }
    }
}
