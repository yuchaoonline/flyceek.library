...
namespace ComLib.ValidationSupport
{
    ...
    public static partial class Validation
    {
        ...
        /// <returns></returns>
        public static bool AreEqual<T>(T obj1, T obj2, IValidationResults errors, string tag) where T : IComparable<T>
        {
            return CheckError(obj1.CompareTo(obj2) == 0, errors, tag, "Objects supplied are not equal", null);
        }
        ...
        /// <param name="obj2"></param>
        /// <returns></returns>
        public static bool AreNotEqual<T>(T obj1, T obj2, IValidationResults errors, string tag) where T : IComparable<T>
        {
            return CheckError(obj1.CompareTo(obj2) != 0, errors, tag, "Objects supplied are equal", null);
        }
        ...
        public static BoolMessage AreNoneNull(string[] items, string[] itemNames, string errorSuffix, string multilineSeparator)
        {
            ...
            string errorMessage = success ? string.Empty : ValidationUtils.BuildSingleErrorMessage(errors, separator);
