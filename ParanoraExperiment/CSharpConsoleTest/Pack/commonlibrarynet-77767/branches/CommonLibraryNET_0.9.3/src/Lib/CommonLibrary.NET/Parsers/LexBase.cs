...
namespace ComLib.Parsing
{
    ...
    public class LexBase
    {
        ...
        public void Init(LexSettings settings)
        {
        ...
        public virtual List<string> ParseText(string line)
        {
            ...
            while (!_reader.IsEnd())
            {
                ...
                {
                    _tokenList.Add(ReadNonQuotedToken(_whiteSpaceMap));
                }
        ...
        /// </summary>
        /// <returns></returns>
        protected string ReadNonQuotedToken(IDictionary<string, string> separators)
        {
