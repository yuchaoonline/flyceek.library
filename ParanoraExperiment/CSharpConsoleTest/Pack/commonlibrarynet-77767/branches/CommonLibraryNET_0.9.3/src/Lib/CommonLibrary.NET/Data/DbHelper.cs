...
{    
    ...
    public class DBHelper : IDBHelper
    {
        ...
        /// </summary>
        public DBHelper() : this(ConnectionInfo.Default, new DbSettings(), null)
        { 
        }
        ...
        public DBHelper(ConnectionInfo connection) : this(connection, new DbSettings(), null)
        {
        }
        ...
        /// </summary>
        /// <param name="connection"></param>
        public DBHelper(string connectionString, DbProviderFactory factory)
        {
        ...
        /// </summary>
        /// <param name="connection"></param>
        public DBHelper(ConnectionInfo connection, DbSettings settings, DbProviderFactory factory)
        {
