...
namespace CommonLibrary
{
    ...
    /// </summary>
    public class AuthServiceWindows : IAuthService
    {
        ...
        public AuthServiceWindows(string adminRoleName, IPrincipal user)
        {
        ...
        {
            return CommonLibrary.Security.RoleHelper.IsInRoles(rolesDelimited, _user);
        }
