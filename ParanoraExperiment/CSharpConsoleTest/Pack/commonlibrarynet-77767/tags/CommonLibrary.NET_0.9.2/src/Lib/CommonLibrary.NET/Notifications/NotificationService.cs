...
namespace CommonLibrary
{
    ...
    {
        protected QueueProcessor<NotificatonMessage> _queue = null;
        ...
        public NotificationServiceBase(QueueProcessor<NotificatonMessage> queue, NotificationSettings settings)
        {
            _settings = settings;
            _queue = queue;
        }
        ...
        /// </summary>
        public QueueProcessor<NotificatonMessage> Queue
        {
            get { return _queue; }
            set { _queue = value; }
        }
        ...
        protected void Notify(NotificatonMessage message)
        {
    ...
    {
        public NotificationAccountService(QueueProcessor<NotificatonMessage> queue, NotificationSettings settings)
            : base(queue, settings)
        {
        }
        ...
        {
            Notify(new NotificatonMessage(ctx.Values, ctx.Values["message.to"], string.Empty, 
    ...
    {
        public NotificationMessagingService(QueueProcessor<NotificatonMessage> queue, NotificationSettings settings ) 
            : base(queue, settings)
        {
        }
