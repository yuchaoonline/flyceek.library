...
namespace CommonLibrary.DomainModel
{
    ...
    public class ActiveRecord<T> where T : IDomainObject<T>, new()
    {
        ...
        /// <returns></returns>
        public static BoolResult<IList<T>> Get(int pageNumber, int pageSize, ref int totalPages, ref int totalRecords)
        {
            IEntityService<T> service = ActiveRecordRegistration.GetService<T>();
            BoolResult<IList<T>> result = service.Get(pageNumber, pageSize, ref totalPages, ref totalRecords);
            return result;
        }
        ...
        /// <param name="totalRecords">Total number of records found.</param>
        /// <returns></returns>
        public static BoolResult<IList<T>> GetByFilter(string filter, int pageNumber, int pageSize, ref int totalPages, ref int totalRecords)
        {
            IEntityService<T> service = ActiveRecordRegistration.GetService<T>();
            BoolResult<IList<T>> result = service.GetByFilter(filter, pageNumber, pageSize, ref totalPages, ref totalRecords);
            return result;
        }
        ...
        /// <param name="totalRecords">Total number of records found.</param>
        /// <returns></returns>
        public static BoolResult<IList<T>> GetRecent(int pageNumber, int pageSize, ref int totalPages, ref int totalRecords)
        {
            IEntityService<T> service = ActiveRecordRegistration.GetService<T>();
            BoolResult<IList<T>> result = service.GetRecent(pageNumber, pageSize, ref totalPages, ref totalRecords);
            return result;
        }
        #endregion
