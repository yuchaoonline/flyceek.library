...
namespace CommonLibrary.DomainModel
{
    ...
    public interface IEntityService<T> 
    {
        ...
        /// <returns></returns>
        BoolResult<IList<T>> Get(int pageNumber, int pageSize, ref int totalPages, ref int totalRecords);
        ...
        /// <param name="totalRecords">60</param>
        /// <returns></returns>
        BoolResult<IList<T>> GetByFilter(string filter, int pageNumber, int pageSize, ref int totalPages, ref int totalRecords);
        ...
        /// <param name="totalRecords">Total number of records found.</param>
        /// <returns></returns>
        BoolResult<IList<T>> GetByUser(string userName, int pageNumber, int pageSize, ref int totalPages, ref int totalRecords);
        ...
        /// <param name="totalRecords">60</param>
        /// <returns></returns>
        BoolResult<IList<T>> GetRecent(int pageNumber, int pageSize, ref int totalPages, ref int totalRecords);
