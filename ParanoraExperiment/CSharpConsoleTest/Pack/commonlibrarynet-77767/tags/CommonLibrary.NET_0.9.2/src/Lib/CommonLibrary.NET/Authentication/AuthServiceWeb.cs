...
namespace CommonLibrary
{
    ...
    /// </summary>
    public class AuthServiceWeb : IAuthService
    {
        ...
        public AuthServiceWeb(string adminRoleName)
        {
        ...
        /// </summary>
        /// <param name="adminRoleName"></param>
        public AuthServiceWeb(string adminRoleName, Func<string, IPrincipal> userAuthService)
        {
            _adminRoleName = adminRoleName;
        ...
        {
            return CommonLibrary.Security.RoleHelper.IsUserInRoles(rolesDelimited);
        }
