...
namespace CommonLibrary
{
    ...
    public class LoggerConsole : LoggerBase, ILog
    {
        ...
        /// </summary>
        public LoggerConsole() : base(typeof(LoggerConsole).FullName) 
        { 
        }
        ...
        /// </summary>
        public LoggerConsole(string name) : this(name, false)
        {
        }
        ...
        /// Constructor with name.
        /// </summary>
        public LoggerConsole(string name, bool useColorCoding) : base(name)
        {
        }
