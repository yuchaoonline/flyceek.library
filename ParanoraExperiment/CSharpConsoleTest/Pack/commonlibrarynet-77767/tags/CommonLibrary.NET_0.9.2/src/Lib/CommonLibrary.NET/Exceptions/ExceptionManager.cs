...
namespace CommonLibrary
{
    ...
    {
        private static IExceptionManager _provider;
        private static ILocalizedExceptionManager _localizedProvider;
        private static object _syncRoot = new object();
        private static IDictionary<string, IExceptionManager> _namedHandlers;
        ...
        {
            _localizedProvider = new ExceptionManagerDefaultLocalized();
            _provider = _localizedProvider;
            _namedHandlers = new Dictionary<string, IExceptionManager>();
        ...
        public static void Init(IExceptionManager provider)
        {
            lock (_syncRoot)
            {
                _provider = provider;
        ...
        public static void Register(string name, bool isDefault, IExceptionManager handler)
        {
            lock (_syncRoot)
            {                
                if (isDefault)
        ...
        private static void InternalHandle(object error, Exception exception, string handler, IStatusResults errorResults, object[] arguments)
        {
            ...
            IExceptionManager exceptionManager = _namedHandlers[handler];
