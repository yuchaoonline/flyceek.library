...
namespace CommonLibrary
{
    ...
    /// </summary>
    public class CryptographerServiceSymmetric : ICryptographyService
	{
        protected CryptographySettings _encryptionOptions;
        ...
        /// Default options
        /// </summary>
        public CryptographerServiceSymmetric()
        {
            _encryptionOptions = new CryptographySettings();
        ...
        public CryptographerServiceSymmetric(string key, SymmetricAlgorithm algorithm)
        {
            _encryptionOptions = new CryptographySettings(true, key);
        ...
        /// </summary>
        /// <param name="options">The options.</param>
        public CryptographerServiceSymmetric(CryptographySettings options, SymmetricAlgorithm algorithm)
        {
        ...
        /// </summary>
        /// <value></value>
        public CryptographySettings Settings
        {
