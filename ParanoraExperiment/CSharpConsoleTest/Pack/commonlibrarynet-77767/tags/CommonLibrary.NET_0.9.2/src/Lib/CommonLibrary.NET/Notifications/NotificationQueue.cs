...
namespace CommonLibrary
{
    ...
    /// </summary>
    public class NotificationQueueInMemory : QueueProcessor<NotificatonMessage>
    {
        ...
        protected override void Process(IList<NotificatonMessage> itemsToProcess)
        {            
            // Now send each message.
            foreach (NotificatonMessage message in itemsToProcess)
            {
    ...
    public class NotificationItemProcessor
    {
        ...
        public void Process(NotificatonMessage currentMessage)
        {
            try
            {
        ...
        private void OutputContent(NotificatonMessage message, string htmlBody)
        {
