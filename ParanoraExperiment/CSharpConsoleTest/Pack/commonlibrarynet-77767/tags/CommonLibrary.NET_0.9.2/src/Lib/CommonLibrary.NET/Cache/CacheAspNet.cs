...
namespace CommonLibrary
{
    ...
    public class CacheAspNet : ICache
    {
        ...
        private System.Web.Caching.CacheItemPriority ConvertToAspNetPriority(CommonLibrary.CacheItemPriority priority)
        {
            if (priority == CommonLibrary.CacheItemPriority.Default) { return System.Web.Caching.CacheItemPriority.Default; }
            if (priority == CommonLibrary.CacheItemPriority.High) { return System.Web.Caching.CacheItemPriority.High; }
            if (priority == CommonLibrary.CacheItemPriority.Low) { return System.Web.Caching.CacheItemPriority.Low; }
            if (priority == CommonLibrary.CacheItemPriority.Normal) { return System.Web.Caching.CacheItemPriority.Normal; }
