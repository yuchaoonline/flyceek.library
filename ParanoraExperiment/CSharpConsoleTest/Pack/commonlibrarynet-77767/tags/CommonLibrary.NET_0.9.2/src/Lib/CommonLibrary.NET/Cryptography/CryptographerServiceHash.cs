...
namespace CommonLibrary
{
    ...
    /// </summary>
    public class CryptographerServiceHash : ICryptographyService
	{
        ...
        /// Default options
        /// </summary>
        public CryptographerServiceHash()
        {
        ...
        public CryptographerServiceHash(string key, HashAlgorithm algorithm)
        {
        ...
        /// </summary>
        /// <param name="options">The options.</param>
        public CryptographerServiceHash(CryptographySettings options, HashAlgorithm algorithm)
        {
