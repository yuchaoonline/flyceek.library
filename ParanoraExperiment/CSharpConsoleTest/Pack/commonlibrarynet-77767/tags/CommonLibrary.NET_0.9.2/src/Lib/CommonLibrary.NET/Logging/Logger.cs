...
namespace CommonLibrary
{
    ...
    public class Logger
    {
        ...
        {
            { "default", new LoggerMulti( "default", new LoggerConsole("console")) }
        };
        ...
        {
            LogEvent logEvent = LoggerHelper.BuildLogEvent(typeof(Logger), level, message, exception, args);
        ...
        {
            ILog logger = new LoggerInstance(loggerName, typeof(T));
            return logger;
        }
        ...
        public static void Clear()
        {
            ...
            {
                _loggers.Clear();
                _loggers["default"] = new LoggerMulti("default", new LoggerConsole());
            });
        }
        ...
        public static void Init(ILogMulti logger)
        {
            ExecuteWrite(() => 
            {
                ...
                _loggers["default"] = new LoggerMulti("default", new List<ILog>() { logger }); 
            });
        }
        ...
        public static List<string> GetLogInfo()
        {
            ...
            ExecuteRead(() => _loggers.ForEach(logger =>
            {
                ...
                for (int ndx = 0; ndx < logger.Value.Count; ndx++)
                {
                    ...
                    if (log is LoggerFileBased)
                    {
                        string info = "NAME:'" + logger.Key + "-" + log.Name + "'"
                                    + ", LEVEL: " + log.Level.ToString() 
                                    + ", PATH: " + ((LoggerFileBased)log).FilePath;
                        logSummary.Add(info);
                    }
                }
            }));
