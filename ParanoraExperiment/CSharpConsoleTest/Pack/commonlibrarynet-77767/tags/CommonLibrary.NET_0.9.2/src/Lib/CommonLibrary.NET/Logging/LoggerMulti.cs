...
namespace CommonLibrary
{
    ...
    /// </summary>
    public class LoggerMulti : LoggerBase, ILogMulti
    {
        ...
        public LoggerMulti(string name, ILog logger) : base(typeof(LoggerMulti).FullName)
        {
        ...
        /// </summary>
        /// <param name="loggers"></param>
        public LoggerMulti(string name, IList<ILog> loggers) : base(typeof(LoggerMulti).FullName)
        {
            Init(name, loggers);
        }
        ...
        public void Clear()
        {
            ...
            {
                _loggers.Clear();
                _loggers.Add("console", new LoggerConsole());
            });
        }
