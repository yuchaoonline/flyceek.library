...
namespace CommonLibrary
{
    ...
    /// </summary>
    public class HolidayCalendarService : IHolidayCalendar
    {
        ...
        private IHolidaysDataProvider _holidayDataProvider;
        ...
        public HolidayCalendarService(string calendarCode, IHolidaysDataProvider provider, int forwardBackRange)
        {
        ...
        /// </summary>
        public IHolidaysDataProvider HolidayProvider
        {
        ...
        public virtual void Init(string calendarCode, IHolidaysDataProvider provider, int startYear, int endYear)
        {
            _calendarCode = calendarCode;
            _holidayDataProvider = provider;
            _holidayDataProvider.CalendarCode = _calendarCode;
            List<KeyValuePair<int, List<DateTime>>> holidays = _holidayDataProvider.GetHolidays(startYear, endYear);
        ...
        /// <param name="year"></param>
        /// <returns></returns>
        public List<DateTime> GetWeekends(int year)
        {
            if (!IsHolidayDataAvailable(year)) return null;
        ...
        /// <param name="year"></param>
        /// <returns></returns>
        public List<DateTime> GetBusinessDays(int year)
        {
            if (!IsHolidayDataAvailable(year)) return null;
        ...
        {
            return GetNextBusinessDate(date, true, 1);
        }
        ...
        /// <param name="date"></param>
        /// <returns></returns>
        public DateTime GetPreviousBusinessDate(DateTime date)
        {
            return GetNextBusinessDate(date, true, -1);
        }
        ...
        /// <param name="year"></param>
        /// <returns></returns>
        public DateTime GetFirstBusinessDateOfMonth(int month, int year)
        {
            DateTime date = new DateTime(year, month, 1);
            date = date.AddDays(-1);
            return GetNextBusinessDate(date, date.Year == year, 1);
        }
        ...
        /// <param name="year"></param>
        /// <returns></returns>
        public DateTime GetFirstBusinessDateOfYear(int year)
        {
        ...
        /// <param name="year"></param>
        /// <returns></returns>
        public DateTime GetLastBusinessDateOfMonth(int month, int year)
        {
            DateTime date = new DateTime(year, month, 1);
            return GetNextBusinessDate(date, true, -1);
        }
        ...
        /// <param name="year"></param>
        /// <returns></returns>
        public DateTime GetLastBusinessDateOfYear(int year)
        {
            DateTime date = new DateTime(year, 1, 1);
            return GetNextBusinessDate(date, true, -1);
        }
        ...
        private DateTime GetNextBusinessDate(DateTime date, bool checkYear, int incrementor)
        {
