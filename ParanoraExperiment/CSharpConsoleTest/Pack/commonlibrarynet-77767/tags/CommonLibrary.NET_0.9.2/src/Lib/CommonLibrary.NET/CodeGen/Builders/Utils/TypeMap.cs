...
namespace CommonLibrary.CodeGeneration
{
    ...
    public class TypeMap
    {
        ...
        public static void RegisterDefaultTypeMaps()
        {
            ...
            sqlServerTypes[typeof(CommonLibrary.Models.StringClob).Name] = "ntext";
            ...
            netTypes.Add(typeof(CommonLibrary.Models.StringClob).Name, "string");
            ...
            netFullNamesToTypes.Add(typeof(CommonLibrary.Models.StringClob).FullName, typeof(CommonLibrary.Models.StringClob));
